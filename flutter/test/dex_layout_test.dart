...
void main() {
  ...
  testWidgets('TitoProgressBar fill width matches value fraction', (
    ...
    final fillWidth = tester
        ...
        .width;
    // The fill is a fraction of the track's content box, i.e. the outer width
    // minus both ink strokes — allow for that plus a pixel of rounding.
    expect(
      fillWidth,
      moreOrLessEquals(trackWidth * 0.5, epsilon: TitoBorders.element + 1),
    );
  });
