...
class AppVisualStylePreference extends ChangeNotifier {
  ...
  // New installs keep TitoDex's shipping visual identity. Explicit choices
  // (including the legacy `material` preview value) are restored in [load].
  AppVisualStyle _style = AppVisualStyle.classic;
  bool _loaded = false;
