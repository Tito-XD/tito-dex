...
abstract final class AppZh {
  ...
  static const settingsCategoryProfile = '游戏与训练家';
  static const settingsCategoryProfileHint = '游戏版本、头像、显示名称与旅程状态';
  static const settingsCategoryAssistant = '助手与扩展';
  static const settingsCategoryAssistantHint = '旅程助手、在线问答与搜索展示';
  static const settingsCategoryCompanion = '同行宝可梦';
  static const settingsCategoryCompanionHint = '显示、大小、位置与媒体资源';
  static const settingsCategoryAppearance = '界面与快捷方式';
  static const settingsCategoryAppearanceHint = '应用主题、表面层次、动画与桌面入口';
  static const settingsCategoryData = '数据与存储';
  static const settingsCategoryDataHint = '离线资料、存档同步与模拟器';
  static const settingsCategoryAbout = '关于与高级';
  static const settingsCategoryAboutHint = '数据来源、许可、导入导出与重置';
  static const settingsGroupInterface = '界面风格';
  static const settingsVisualTheme = '应用主题';
  static const settingsVisualThemeHint = '主题会全局应用并自动保存，不影响资料与功能。';
  static const settingsRetroStyle = '卡片层次';
  static const settingsRetroStyleHint = '开启后卡片带有高度或阴影；关闭后使用更平的描边表面。';
