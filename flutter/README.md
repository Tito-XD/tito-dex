...
**Latest release:** `0.9.5+187` / `0.9.5-offline+188` · [GitHub Release v0.9.5](https://github.com/Tito-XD/tito-dex/releases/tag/v0.9.5)

**Current `main` package version:** `0.9.5+187`
