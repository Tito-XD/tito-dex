...
**Latest release:** `0.8.10+146` / `0.8.10-offline+147` · [GitHub Release v0.8.10](https://github.com/Tito-XD/tito-dex/releases/tag/v0.8.10)

**Current `main` package version:** `0.8.10+146`
