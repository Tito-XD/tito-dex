/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 9beb839f397764ebd722319c752d7dd3)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	JOURNEY_CONTENT: R2Bucket;
	DEX_CONTENT: R2Bucket;
	QUESTION_RATE_LIMITER: RateLimit;
	JOURNEY_SEARCH_NAMESPACE: AiSearchNamespace;
	AI: Ai;
	AI_MODEL: string;
	AI_GATEWAY_ID: string;
	AI_SEARCH_ENABLED: string;
	CURATED_WEB_ENABLED: string;
	TAVILY_WEB_ENABLED: string;
	EXPERIMENTAL_BROAD_ANSWERS: string;
	DEEPSEEK_NATIVE_SEARCH_ENABLED: string;
	DEEPSEEK_NATIVE_PROVIDER: string;
	DEEPSEEK_NATIVE_KEY_ALIAS: string;
	AI_EXTERNAL_PROVIDER_ENABLED: string;
	AI_PROVIDER: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "AI_GATEWAY_ID" | "AI_SEARCH_ENABLED" | "CURATED_WEB_ENABLED" | "TAVILY_WEB_ENABLED" | "EXPERIMENTAL_BROAD_ANSWERS" | "DEEPSEEK_NATIVE_SEARCH_ENABLED" | "DEEPSEEK_NATIVE_PROVIDER" | "DEEPSEEK_NATIVE_KEY_ALIAS" | "AI_EXTERNAL_PROVIDER_ENABLED" | "AI_PROVIDER" | "AI_PROVIDER_MODEL" | "AI_PROVIDER_ENDPOINT" | "TAVILY_API_KEY" | "CF_ACCOUNT_ID" | "CF_AIG_TOKEN">> {}
}
