...
**Production:** `https://dex.tito.cafe` · Worker **`tito-dex`** · R2 **`titodex-dex`** · live bundle **v20** on `/v5/`; v0.9.18 Offline embeds the verified v20 archive

旧 `deploy/dex-cdn` 分支尚未随 main 署名清理迁移；当前从验证后的 main 使用独立 CLI 部署，见下方说明。
