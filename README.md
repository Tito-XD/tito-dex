...
| 渠道 | 版本 | 说明 |
| --- | --- | --- |
| Lite APK | [v0.8.18](https://github.com/Tito-XD/tito-dex/releases/tag/v0.8.18) · App `0.8.18+170` | 流式核验回答、问答界面细节与本地记录管理 |
| Offline APK | [v0.8.18](https://github.com/Tito-XD/tito-dex/releases/tag/v0.8.18) · App `0.8.18-offline+171` | 内置紧凑 v14 图鉴数据与旅程助手 |
...
前往 [GitHub Releases](https://github.com/Tito-XD/tito-dex/releases) 下载 **`TitoDex-0.8.18-lite-rg-arm64.apk`** 或 **`TitoDex-0.8.18-offline-rg-arm64.apk`**。两个版本都面向 arm64-v8a Android 设备。v0.8.18 可直接从 v0.8.13–v0.8.17 升级；从 v0.8.12 或更早版本升级时，仍需先导出旅程、卸载旧版。
