...
Download **`TitoDex-0.8.16-lite-rg-arm64.apk`** or **`TitoDex-0.8.16-offline-rg-arm64.apk`** from [GitHub Releases](https://github.com/Tito-XD/tito-dex/releases). Both target arm64-v8a Android devices. v0.8.16 upgrades directly from v0.8.13–v0.8.15; Android signing was rotated in v0.8.13, so v0.8.12 or earlier still requires export, uninstall, and reinstall.
