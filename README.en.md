...
| --- | --- | --- |
| Lite APK | [v0.8.17](https://github.com/Tito-XD/tito-dex/releases/tag/v0.8.17) · App `0.8.17+168` | Modern chat UI, segmented controls, and local history management |
| Offline APK | [v0.8.17](https://github.com/Tito-XD/tito-dex/releases/tag/v0.8.17) · App `0.8.17-offline+169` | Embeds compact v14 Dex data and Journey Assistant |
...
Download **`TitoDex-0.8.17-lite-rg-arm64.apk`** or **`TitoDex-0.8.17-offline-rg-arm64.apk`** from [GitHub Releases](https://github.com/Tito-XD/tito-dex/releases). Both target arm64-v8a Android devices. v0.8.17 upgrades directly from v0.8.13–v0.8.16; Android signing was rotated in v0.8.13, so v0.8.12 or earlier still requires export, uninstall, and reinstall.
