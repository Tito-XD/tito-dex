# v0.4.0 Implementation Handoff (Archived)
...
> **用途：** 保留 v0.4.0 时期的 build → upload → Flutter 开发 → 发版决策记录，不得作为当前操作手册。
>
...
| # | 项 |
| --- | --- |
| D1 | 地区菜单 **11 区全开**，默认高亮当前游戏相关地区 |
| D2 | 全国 **1–1025** 浏览/搜索 |
| D3 | 版本栏改为 23 游戏（或分组折叠） |
...
- HGSS `.sav` seen/caught 仍限 **493** 全国图鉴位图。
- 1025 浏览不影响存档解析。
