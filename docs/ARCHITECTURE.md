...
> Current release: v0.8.15 · Lite `0.8.15+162` · Offline `0.8.15-offline+163` · chat-first built-in Journey Assistant with allowlisted web retrieval · live bundle v19 / compact seed v14.
>
