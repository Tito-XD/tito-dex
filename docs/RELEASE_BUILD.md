...
The latest published pair is the v0.8.13 rebuild with Lite versionCode `156`
and Offline versionCode `157`. A later release must use a product version newer
than `0.8.13`, a Lite versionCode greater than `157`, and an even larger Offline
