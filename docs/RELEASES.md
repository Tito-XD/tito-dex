...
| --- | --- | --- |
| Lite APK | `v0.6.2` (`0.6.2+71`) | Recommended arm64-v8a download |
| Offline APK | `v0.6.2` (`0.6.2-offline+72`) | Larger package with the core dex bundle embedded |
| Source on `main` | `0.6.2+71` | Current default branch baseline |
