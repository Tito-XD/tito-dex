...
| 渠道 | 当前版本 | 用途 |
| --- | --- | --- |
| Lite APK | `v0.8.12`（`0.8.12+152`） | 推荐的 arm64-v8a 安装包，按需下载离线数据 |
| Offline APK | `v0.8.12`（`0.8.12-offline+153`） | 内置紧凑 v14 种子，并可更新到 v19 |
| `main` 源码 | `0.8.12+152` | 当前默认分支基线 |
...
完整历史以 [GitHub Releases](https://github.com/Tito-XD/tito-dex/releases) 为准。2026-08-08 已逐条审计当时全部 89 个公开 Release：0.8.8 原本符合模板，其余 88 个版本的英文正文／区块名、缺少开场概述、空下载文件名、CI 临时路径和相邻版本复制错误均已完成统一修正。随后发布的 v0.8.9–v0.8.12 继续沿用本页中文模板。
