...
| 渠道 | 当前版本 | 用途 |
| --- | --- | --- |
| Lite APK | `v0.8.17`（`0.8.17+168`） | 推荐的 arm64-v8a 安装包；助手需首次明确开启 |
| Offline APK | `v0.8.17`（`0.8.17-offline+169`） | 内置紧凑 v14 种子；助手仍默认关闭，并可更新到 v19 |
| Journey Assistant | 主 App 内建、默认关闭 | 三段状态入口、记录管理、现代回答动效、实体跳转 Chip 与多源搜索 |
