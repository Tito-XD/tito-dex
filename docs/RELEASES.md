...
| 渠道 | 当前版本 | 用途 |
| --- | --- | --- |
| Lite APK | `v0.8.10`（`0.8.10+146`） | 推荐的 arm64-v8a 安装包，按需下载离线数据 |
| Offline APK | `v0.8.10`（`0.8.10-offline+147`） | 内置紧凑 v14 种子，并可更新到 v19 |
| `main` 源码 | `0.8.10+146` | 当前默认分支基线 |
...
| Tag | 标准标题 | 版本结果 |
| --- | --- | --- |
| `v0.8.10` | TitoDex v0.8.10 · 丰富存档与可靠返回 | HGSS 同步扩充到队伍与训练家完整实用字段；修正 HP 读取；图鉴详情返回保留浏览位置；App 与 README 补齐数据、媒体 Credits 和非官方声明。 |
