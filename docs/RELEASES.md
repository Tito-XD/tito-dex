...
| 渠道 | 当前版本 | 用途 |
| --- | --- | --- |
| Lite APK | `v0.8.16`（`0.8.16+166`） | 推荐的 arm64-v8a 安装包；助手需首次明确开启 |
| Offline APK | `v0.8.16`（`0.8.16-offline+167`） | 内置紧凑 v14 种子；助手仍默认关闭，并可更新到 v19 |
| Journey Assistant | 主 App 内建、默认关闭 | 首次授权、完整状态弹窗、50 组问答、实体跳转卡片与多源搜索 |
