...
| `v0.8.6` | TitoDex v0.8.6 · 资料筛选与详情修复 | Adds an 18-type move filter and compact categories for abilities, natures, egg groups, weather, and status; normalizes raw stat keys to Chinese labels throughout dex details; and makes the first system-back action close the artwork viewer correctly. Lite and Offline keep the existing v13/v14 data archives. |
