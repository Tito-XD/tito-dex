...
| 渠道 | 当前版本 | 用途 |
| --- | --- | --- |
| Lite APK | `v0.8.15`（`0.8.15+162`） | 推荐的 arm64-v8a 安装包，内建通用问答与紧凑对话页 |
| Offline APK | `v0.8.15`（`0.8.15-offline+163`） | 内置紧凑 v14 种子与旅程助手，并可更新到 v19 |
| Journey Assistant | 主 App 内建 | 4/4 状态弹窗、固定输入框、伴侣等待动画与限定搜索 |
