...
| --- | --- | --- |
| Lite APK | `v0.6.1` (`0.6.1+69`) | Recommended arm64-v8a download |
| Offline APK | `v0.6.1` (`0.6.1-offline+70`) | Larger package with the core dex bundle embedded |
| Source on `main` | `0.6.1+69` | Current default branch baseline |
