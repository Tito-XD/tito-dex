...
| Field | Value |
| --- | --- |
| **Latest release** | [v0.8.17](https://github.com/Tito-XD/tito-dex/releases/tag/v0.8.17) |
| **`main` / lite source** | `0.8.17+168` (`flutter/pubspec.yaml`) |
| **Offline package** | `0.8.17-offline+169` — APK-bundled verified compact v14 archive; updates to live v19 |
...
- **Last iOS build verification (2026-07-23, v0.7.0)**: `pod install`,
  ...
  Runner.app). v0.8.17 passes the shared Dart suite, but its iOS no-codesign
...
Published v0.8.17 artifacts are verified through the Android release workflows;
