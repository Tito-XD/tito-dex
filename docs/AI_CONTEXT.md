...
| **`main` / lite source** | `0.8.16+166` (`flutter/pubspec.yaml`) |
| **Offline package** | `0.8.16-offline+167` — APK-bundled verified compact v14 archive; updates to live v19 |
